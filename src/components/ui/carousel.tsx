...
// Embla Carousel - https://www.embla-carousel.com/guides/slide-container/
// TODO: Move this to acm-components
...
const CarouselContent = React.forwardRef<HTMLDivElement, CarouselContentProps>(
  ({ className, containerClassname, ...props }, ref) => {
    ...
    return (
      // Adding containerClassname for custom first container styles
